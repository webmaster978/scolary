...
<?php
    ...
    $card = $db->prepare("SELECT * FROM eleves inner join classe on ref_classe = classe.id_classe WHERE id_eleves=:idp");
	$card->execute([
		'idp' => $idp
	]);
...
<p><b>Mobile :</b> <?=ucwords($carte->contact); ?></p>
<p><b>Email :</b> <a href="#"><?=$carte->contact; ?></a></p>
<p><b>Address :</b> <?=$carte->contact; ?> </p>
</div>
</div>
